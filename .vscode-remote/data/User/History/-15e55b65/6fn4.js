...
suite('Unit Tests', () => {
  ...
  suite("To American English", function(){
    ...
    test("We watched the footie match for a while.", function(done){
      assert.equal(translator.amerToBrit("We watched the footie match for a while."),
    ...
    test("Paracetamol takes up to an hour to work.", function(done){
      assert.equal(translator.amerToBrit("Paracetamol takes up to an hour to work."),
    ...
    test("First, caramelise the onions.", function(done){
      assert.equal(translator.amerToBrit("First, caramelise the onions."),
    ...
    test("I spent the bank holiday at the funfair.", function(done){
      assert.equal(translator.amerToBrit("I spent the bank holiday at the funfair."),
    ...
    test("I had a bicky then went to the chippy.", function(done){
      assert.equal(translator.amerToBrit("I had a bicky then went to the chippy."),
    ...
    test("I've just got bits and bobs in my bum bag.", function(done){
      assert.equal(translator.amerToBrit("I've just got bits and bobs in my bum bag."),
      'Ive just got bits and bobs in my bum bag.' // fix this
      );
      done();
    });

    test("The car boot sale at Boxted Airfield was called off.", function(done){
      assert.equal(translator.amerToBrit("The car boot sale at Boxted Airfield was called off."),
